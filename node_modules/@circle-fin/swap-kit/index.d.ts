 ...
 * ```
 */
declare const getChainByEnum: (blockchain: Blockchain | `${Blockchain}`) => ChainDefinition;
 ...
 * ```
 */
declare class StablecoinServiceSwapProvider implements SwappingProvider {
    /** The name of the provider */
    readonly name = "StablecoinServiceSwapProvider";
    /**
     * Array of chains supported by this swap provider.
     *
     ...
     */
    private handleEvmTokenApproval;
    /**
     ...
     * @throws Error if transaction confirmation fails or times out
     */
    private handleStandardApproval;
    /**
...
declare class SwapKit {
     ...
     * ```
     */
    estimate(params: SwapParams): Promise<SwapEstimate>;
    /**
 ...
 * @internal
 */
declare const getDefaultProviders: () => readonly [StablecoinServiceSwapProvider];
/**
 * Type alias for the default providers returned by getDefaultProviders.
 *
 * Exported to allow proper type extraction from SwapKitContext.
 */
 ...
 * ```
 */
declare function createSwapKitContext<TExtraProviders extends FlexibleSwappingProvider[] = []>(config?: SwapKitConfig<TExtraProviders>): SwapKitContext<[...DefaultProviders, ...TExtraProviders]>;
 ...
 * ```
 */
declare function estimate<TFromAdapterCapabilities extends AdapterCapabilities>(context: SwapKitContext, params: SwapParams<TFromAdapterCapabilities>): Promise<SwapEstimate>;
 ...
 * ```
 */
declare function swap<TFromAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(context: SwapKitContext, params: SwapParams<TFromAdapterCapabilities>): Promise<SwapResult>;
 ...
 * ```
 */
declare function getSupportedChains(context: SwapKitContext): ChainDefinition[];
 ...
 * ```
 */
declare function setCustomFeePolicy<TProviders extends readonly FlexibleSwappingProvider[] = readonly FlexibleSwappingProvider[]>(context: SwapKitContext<TProviders>, customFeePolicy: CustomFeePolicy): SwapKitContext<TProviders>;
 ...
 * ```
 */
declare function removeCustomFeePolicy(context: SwapKitContext): SwapKitContext;
 ...
 * ```
 */
declare function resolveSwapParams<TFromAdapterCapabilities extends AdapterCapabilities = AdapterCapabilities>(params: SwapParams<TFromAdapterCapabilities>, tokens: TokenRegistry): Promise<ResolvedSwapParams<TFromAdapterCapabilities>>;
 ...
 * ```
 */
declare const swapParamsSchema: z.ZodType;
/**
 ...
 * ```
 */
declare const customFeePolicySchema: z.ZodObject<{
    computeFee: z.ZodFunction<z.ZodTuple<[], z.ZodUnknown>, z.ZodUnion<[z.ZodString, z.ZodPromise<z.ZodString>]>>;
    resolveFeeRecipientAddress: z.ZodFunction<z.ZodTuple<[], z.ZodUnknown>, z.ZodUnion<[z.ZodString, z.ZodPromise<z.ZodString>]>>;
}, "strict", z.ZodTypeAny, {
    computeFee: (...args: unknown[]) => string | Promise<string>;
    resolveFeeRecipientAddress: (...args: unknown[]) => string | Promise<string>;
}, {
    computeFee: (...args: unknown[]) => string | Promise<string>;
    resolveFeeRecipientAddress: (...args: unknown[]) => string | Promise<string>;
}>;
 ...
 * ```
 */
declare function assertCustomFeePolicy(config: unknown): asserts config is CustomFeePolicy;
 ...
 * ```
 */
declare function assertSwapParams<T>(params: unknown, schema: z.ZodSchema<T>): asserts params is T;

export { Blockchain, KitError, SwapChain, SwapKit, assertCustomFeePolicy, assertSwapParams, createSwapKitContext, customFeePolicySchema, estimate, getChainByEnum, getErrorCode, getErrorMessage, getSupportedChains, isFatalError, isInputError, isKitError, isRetryableError, removeCustomFeePolicy, resolveSwapParams, setCustomFeePolicy, setExternalPrefix, swap, swapParamsSchema };
export type { AdapterContext, AllowanceStrategy, ChainDefinition, ChainIdentifier$1 as ChainIdentifier, CustomFeePolicy, ErrorDetails, Recoverability, SwapAdapterContext, SwapChainDefinition, SwapChainIdentifier, SwapConfig, SwapEstimate, SwapFeeContext, SwapInputFeeContext, SwapKitConfig, SwapKitContext, SwapOutputFeeContext, SwapParams, SwapResult };
