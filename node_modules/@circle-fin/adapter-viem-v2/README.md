...
- [Viem v2 Adapter](#viem-v2-adapter)
  ...
  - [Quick Start](#quick-start)
    ...
    - [🌐 Browser Support with Wallet Providers](#-browser-support-with-wallet-providers)
...
- **Ethereum**: `https://eth.merkle.io` → `https://ethereum.publicnode.com` 🔄
- **Base**: `https://mainnet.base.org` → `https://base.publicnode.com` 🔄
- **Polygon**: `https://polygon.publicnode.com` → `https://polygon.drpc.org` 🔄
- **Unichain**: `https://rpc.unichain.org` → `https://mainnet.unichain.org` 🔄
