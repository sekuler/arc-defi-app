...
**Official Circle SDK for seamless cross-chain USDC bridging**

_Bridge Kit is the recommended integration surface for USDC bridging between EVM and non-EVM chains, making bridging as simple as a single function call_
...
- **🌍 Cross-chain bridging**: The Bridge Kit supports **45 chains** with **968 total bridge routes** through Circle's CCTPv2
