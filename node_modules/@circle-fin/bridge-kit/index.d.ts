 ...
 * ```
 */
declare function resolveChainIdentifier(chainIdentifier: ChainIdentifier$1): ChainDefinition;
...
/**
 * Options for creating a token registry.
 *
 * @remarks
 * The registry always includes built-in tokens (USDC, etc.) by default.
 * Use `tokens` to add custom token definitions that will be merged with
 * the built-ins. Custom tokens with the same symbol as a built-in will
 * override it.
 *
 * @example
 * ```typescript
 * // Add custom tokens (USDC is still available)
 * const registry = createTokenRegistry({
 *   tokens: [myCustomToken],
 * })
 *
 * // Override USDC with custom definition
 * const registry = createTokenRegistry({
 *   tokens: [customUsdcDefinition],
 * })
 * ```
 */
interface TokenRegistryOptions {
    /**
     * Additional token definitions to register.
     * These are merged with built-in tokens (DEFAULT_TOKENS).
     * Tokens with the same symbol as a built-in will override it.
     */
    readonly tokens?: readonly TokenDefinition[];
    /**
     * Require decimals when using raw locator selectors.
     * When true, raw selectors without decimals will throw.
     * @defaultValue false
     */
    readonly requireDecimals?: boolean;
}
/**
 ...
 * ```
 */
declare function createTokenRegistry(options?: TokenRegistryOptions): TokenRegistry;
...
/**
 * Configuration options for {@link createRuntime}.
 *
 * @remarks
 * Only `logger` and `metrics` can be overridden. Internal services
 * (`clock`, `events`) are managed by the SDK.
 */
interface RuntimeOptions {
     ...
     *
     * @remarks
     * Integrate with your existing logging infrastructure (pino, winston, etc.).
     * Must implement debug, info, warn, error, and child methods.
     *
     * Default: pino logger at 'info' level.
     */
    logger?: Logger;
    /**
     ...
     *
     * @remarks
     * Plug into your observability stack (Prometheus, StatsD, DataDog, etc.).
     * Must implement counter, histogram, timer, and child methods.
     *
     * Default: No-op metrics (no collection).
     */
    metrics?: Metrics;
}
/**
...
/**
 * Fallback values for invocation context resolution.
 */
interface InvocationDefaults {
    /** Default runtime to use if not overridden in meta. */
    runtime: Runtime;
    /** Default token registry to use if not overridden in meta. */
 ...
 * ```
 */
declare function resolveInvocationContext(meta: InvocationMeta | undefined, defaults: InvocationDefaults): InvocationContext;
 ...
 * ```
 */
declare function extendInvocationContext(context: InvocationContext, caller: Caller): InvocationContext;
...
declare const bridgeParamsWithChainIdentifierSchema: z.ZodObject<{
    ...
    to: z.ZodUnion<[z.ZodEffects<z.ZodObject<{
        ...
        useForwarder: z.ZodOptional<z.ZodBoolean>;
    }, "strip", z.ZodTypeAny, {
        adapter: {
            prepare: (...args: unknown[]) => unknown;
            waitForTransaction: (...args: unknown[]) => unknown;
        ...
        recipientAddress: string;
        address?: string | undefined;
        useForwarder?: boolean | undefined;
    }, {
        adapter: {
            prepare: (...args: unknown[]) => unknown;
            waitForTransaction: (...args: unknown[]) => unknown;
        ...
        chain: never;
        recipientAddress: z.ZodString;
        useForwarder: z.ZodLiteral<true>;
    }, "strict", z.ZodTypeAny, {
        chain: never;
        recipientAddress: string;
        useForwarder: true;
