...
The Bridge Kit supports chains through Circle's Cross-Chain Transfer Protocol v2 (CCTPv2), enabling **968 total bridge routes** across networks:

### Mainnet Chains (22 chains = 462 routes)
...
### Testnet Chains (23 chains = 506 routes)
