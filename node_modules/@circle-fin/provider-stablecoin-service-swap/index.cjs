 ...
 */
const OK_TOKEN_SYMBOLS = new Set(DEFAULT_TOKENS.map((t) => t.symbol.toUpperCase()));
...
class StablecoinServiceSwapProvider {
    ...
    supportsRoute(tokenInAddress, tokenOutAddress, chain) {
        ...
        return getSwapOkTokenStatus(tokenInAddress, tokenOutAddress, chain, TOKEN_REGISTRY, OK_TOKEN_SYMBOLS).hasOkToken;
    }
    /**
...
exports.StablecoinServiceSwapProvider = StablecoinServiceSwapProvider;
