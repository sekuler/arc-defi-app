...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k13 } = await import("./secp256k1-LNQWNXFU.js");
  const signature_ = (() => {
...
function prepareParameter({ checksumAddress: checksumAddress2 = false, parameter: parameter_, value }) {
  ...
  if (parameter.type.startsWith("uint") || parameter.type.startsWith("int")) {
    ...
    const [, , size4 = "256"] = integerRegex3.exec(parameter.type) ?? [];
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b, from12, to2) => bytesToNumberBE(b.slice(from12, to2));
  class Signature {
...
function verify(options) {
  ...
  return secp256k12.verify(options.signature, from(payload), toBytes2(options.publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
async function fillTransaction(client, parameters) {
  ...
  try {
    ...
    const format3 = ((_d = (_c = chain == null ? void 0 : chain.formatters) == null ? void 0 : _c.transaction) == null ? void 0 : _d.format) || formatTransaction;
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-RUEWJT4O.js").then((module) => module.WebSocket);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-F3VDTKFZ.js.map
